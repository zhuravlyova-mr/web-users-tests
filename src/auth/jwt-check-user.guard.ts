...
@Injectable()
export class JwtCheckUserGuard implements CanActivate {
    ...
    canActivate(context: ExecutionContext): boolean | Promise<boolean> | Observable<boolean> {
        ...
        try {
            ...
            if (user.email == req.body.email) {                      //или самому пользователю
                return true; 
            }
            else { 
                return false; 
            ...
            throw new UnauthorizedException({message: 'Пользователь не прошел авторизацию'})
        }
    }
